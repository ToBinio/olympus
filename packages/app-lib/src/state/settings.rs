    ...
    pub async fn get(
        ...
        let res = sqlx::query!(
            ...
            SELECT
                ...
                theme, default_page, collapsed_navigation, advanced_rendering, native_decorations, allow_multi_instance,
        ...
        Ok(Self {
            ...
            allow_multi_instance: res.allow_multi_instance == 1,
